...
const UserSquareIcon = ({ className }: IconProps) => {
  return (
    <svg
      className={className}
      width="30"
    ...
    >
      <path
        d="M22.6752 27.0249C21.5752 27.3499 20.2752 27.4999 18.7502 27.4999H11.2502C9.72519 27.4999 8.4252 27.3499 7.3252 27.0249C7.6002 23.7749 10.9377 21.2124 15.0002 21.2124C19.0627 21.2124 22.4002 23.7749 22.6752 27.0249Z"
        stroke="#8E51FF"
        strokeWidth="1.875"
        strokeLinecap="round"
