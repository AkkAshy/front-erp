...
const HybridIcon = ({ className, selected }: IconProps) => {
  return (
    <>
      {selected ? (
        <svg
        ...
        >
          <path
            ...
            fill="#8E51FF"
          />
          <rect x="18" y="2" width="22" height="22" rx="11" fill="white" />
          <path
            d="M29 8L35 19H33.5L31.5 15H26.5L24.5 19H23L29 8ZM27 14H31L29 10L27 14Z"
            fill="#8E51FF"
          />
        </svg>
      ) : (
        ...
        >
          ...
          <path
            ...
            strokeLinejoin="round"
          />
          <rect x="18" y="2" width="22" height="22" rx="11" fill="white" stroke="#8E51FF" strokeWidth="1.5" />
          <path
            d="M29 8L35 19H33.5L31.5 15H26.5L24.5 19H23L29 8ZM27 14H31L29 10L27 14Z"
            fill="#8E51FF"
          />
